...
- **Single-package repo.** The PR title always describes the single `@acme-skunkworks/eslint-config` package. If this repo ever splits into multiple packages, both the derive script and the PR-title convention need an updated affected-package detector.
